...
export default function useModalStore() {
    ...
    function showCustomObstacleModalFunc() {
        ...
        customObstacleSubtitle.value = i18n.global.t('Du willst ein individuelles Obstacle? Rail, Ledge oder was ganz anderes – kein Problem!<br><br>Schreib einfach eine kurze Nachricht, wir besprechen was du dir vorstellst und du bekommst ein unverbindliches Angebot.');
    }
